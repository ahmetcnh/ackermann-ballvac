...
#include "ballvac_msgs/msg/map.hpp"
#include "ballvac_msgs/srv/share_map.hpp"
...
{
private:
    rclcpp::Subscription<ballvac_msgs::msg::Map>::SharedPtr sub;
    ...
    rclcpp::Service<ballvac_msgs::srv::ShareMap>::SharedPtr service;

public:
    rclcpp::Client<ballvac_msgs::srv::ShareMap>::SharedPtr client;
    void timer_callback();
    void service_callback(const ballvac_msgs::srv::ShareMap::Request::SharedPtr request, const ballvac_msgs::srv::ShareMap::Response::SharedPtr response);
    void sub_callback(ballvac_msgs::msg::Map::SharedPtr msg);
    ...
    Control() : Node("control_node")
    {
        ...
        this->sub = create_subscription<ballvac_msgs::msg::Map>("/laser_scan", 10, std::bind(&Control::sub_callback, this, _1)); // lidar topic ine subscribe olacak.

        this->service = create_service<ballvac_msgs::srv::ShareMap>("publish_map_service", std::bind(&Control::service_callback, this, _1, _2));
        this->client = create_client<ballvac_msgs::srv::ShareMap>("publish_map_service");
...
void Control::sub_callback(ballvac_msgs::msg::Map::SharedPtr msg)
{
